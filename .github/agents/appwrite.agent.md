---
description: Deep-dive specialist for Appwrite SDK v22.1.3 (node-appwrite). Covers database modeling, auth, permissions, storage, real-time, and server-side SDK usage. Enforces Zod-first validation, document-level permissions, and non-destructive data patterns on every operation.
source: .agents/skills/appwrite/SKILL.md
---
