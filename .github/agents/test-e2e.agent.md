---
description: Redirects to test-master. Specialist for Playwright and full-user-journey verification across authentication, CRUD operations, and cross-browser compliance.
source: .agents/skills/test-e2e/SKILL.md
---
