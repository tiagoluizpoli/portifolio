---
description: Senior React Architect. Designs bulletproof component systems, enforces pattern discipline, and produces production-grade React code using every recognized pattern — Compound, Composite, Render Props, Polymorphic, Slots, and more.
source: .agents/skills/react-architect/SKILL.md
---
