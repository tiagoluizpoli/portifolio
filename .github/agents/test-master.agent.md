---
description: Unified testing specialist covering the full testing pyramid — unit, integration, component, E2E, and coverage enforcement. Demands exhaustive scenario coverage from ideal happy paths to catastrophic failure cascades. Governs Vitest, RTL, Playwright, and Appwrite mocking strategy across backend, frontend, and E2E layers. The goal is the most complete test suite possible.
source: .agents/skills/test-master/SKILL.md
---
