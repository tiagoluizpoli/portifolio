---
description: Redirects to test-master. Specialist for backend testing patterns, including Vitest, Appwrite mocking, and schema validation.
source: .agents/skills/test-backend/SKILL.md
---
