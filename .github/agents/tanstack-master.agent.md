---
description: Expert guidance on building robust, hydration-safe, and high-performance applications with TanStack Start and React 19. Covers file-based routing, type-safe loaders, server functions, middleware, React Query integration, and the full security boundary model.
source: .agents/skills/tanstack-master/SKILL.md
---
