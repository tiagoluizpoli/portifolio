---
description: Tailwind CSS v4.x architect. Expert in CSS-first configuration, deprecated class migration, @theme tokens, @utility directives, and zero-overhead utility systems.
source: .agents/skills/tailwind-architect/SKILL.md
---
