---
description: Universal Prompt Architect. Transforms any engineering, architectural, or design request into a high-fidelity, specialist-driven brief. Wired to all core skills. Fail-proof enhancement pipeline with skill routing, governance injection, and scope enforcement.
source: .agents/skills/prompt-enhancer/SKILL.md
---
