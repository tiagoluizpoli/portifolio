...
source: .agents/skills/gstitch-remotion/SKILL.md
---
...
18: 
19: **PROMPT ENHANCEMENT**: Before execution, you **MUST** invoke the `prompt-enhancer` protocol to transform the video request into a high-fidelity production brief.
20: 
21: ## Prerequisites
