...
import { Activity, ChevronRight, TrendingUp, Users, Zap } from 'lucide-react';
          ...
          <CardHeader className="text-center py-12 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="max-w-md mx-auto text-sm leading-relaxed">
                ...
                integrating your first projects to see real-time access
                analytics and contact inquiries.
              </CardDescription>
            </div>
        ...
        <Card className="border-none shadow-none bg-surface-container-low/20">
          ...
          <CardContent className="space-y-4">
            {[
              ...
              {
                name: 'Elite Designs',
                subject: 'Feedback on UX',
                time: '12h ago',
              },
            ].map((msg) => (
              <div
                key={`${msg.name}-${msg.subject}`}
                className="flex items-center justify-between p-3 bg-foreground/3 rounded-xl hover:bg-primary/5 transition-colors cursor-pointer group"
              >
