...
source: .agents/skills/gstitch-components/SKILL.md
---
...
14: 
15: **PROMPT ENHANCEMENT**: Before execution, you **MUST** invoke the `prompt-enhancer` protocol to transform the component request into a high-fidelity implementation brief.
16: 
