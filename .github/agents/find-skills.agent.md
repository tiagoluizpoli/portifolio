---
description: Autonomous Skill Router. Dynamically discovers all available skills by scanning the filesystem at runtime, reads each skill's own description to build a live knowledge map, and uses semantic reasoning to route any task to the correct specialist squad. Zero hardcoded references — self-expanding as new skills are added.
