    ...
    <header className="sticky top-0 z-10 flex h-14 w-full items-center justify-between px-4 glass-premium border-none">
      ...
      <div className="flex items-center gap-4">
        <Button
          variant="ghost"
          size="icon"
          className="relative h-9 w-9 hover:bg-sidebar-accent/50 rounded-lg group"
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="h-10 gap-3 px-2 hover:bg-sidebar-accent/50 rounded-xl group transition-all"
              id="profile-menu"
            >
              <Avatar className="h-8 w-8 rounded-lg ring-2 ring-primary/10 transition-transform group-hover:scale-105">
                <AvatarImage
                  ...
                  alt="Alex Mercer"
                />
                <AvatarFallback className="rounded-lg bg-primary/20 text-[10px] font-bold text-primary">
                  AM
                </AvatarFallback>
              </Avatar>
              <div className="hidden flex-col items-start gap-0 text-left md:flex">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 leading-tight">
                  Executive VP
                </span>
              </div>
            </Button>
          ...
          <DropdownMenuContent
            align="end"
            className="w-56 glass border-none shadow-2xl p-2 rounded-2xl"
          >
