...
**PROMPT ENHANCEMENT**: Before processing the feature description, you **MUST** invoke the `ultimate-enhancer` protocol to transform the user's input into a high-fidelity engineering brief.
