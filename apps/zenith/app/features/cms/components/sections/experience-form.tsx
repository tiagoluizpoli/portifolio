      ...
      <div className="flex items-end justify-between border-b border-border pb-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground/60 mt-2 font-medium uppercase tracking-widest">
            Section 03 — Orchestrating the Chronological Logic
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            onClick={addItem}
            variant="outline"
            className="border-primary/20 text-primary hover:bg-primary/5 font-bold uppercase tracking-widest text-[10px] px-6 rounded-lg"
          >
                ...
                <div className="flex-1 min-w-0 pr-4">
                  <div className="flex items-center gap-2">
                    <h3 className="text-lg font-bold tracking-tight text-foreground truncate">
                      {item.mainTitle || 'Untitled Role'}
                    </h3>
                    {item.current && (
                      <Badge
                        variant="outline"
                        className="bg-primary/10 text-primary border-primary/20 text-[9px] font-black uppercase tracking-tighter h-5 px-1.5"
                      >
                        Current
                      </Badge>
                    )}
                  </div>
                  <p className="text-xs font-bold text-muted-foreground/40 uppercase tracking-widest mt-0.5">
                    {item.subTitle || 'Unknown Company'}
                  </p>
                </div>
                ...
                <CardContent className="pt-6 border-t border-border space-y-6 animate-in slide-in-from-top-2 duration-300">
                  ...
                  <div className="space-y-3">
                    ...
                    <Textarea
                      ...
                      className="min-h-[160px] bg-transparent border-border rounded-lg resize-none leading-relaxed p-4"
                    />
                  </div>
                </CardContent>
              )}
