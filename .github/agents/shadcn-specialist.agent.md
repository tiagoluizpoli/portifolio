---
description: Expert in shadcn/ui component architecture, Radix primitives, composition patterns, block-level layouts, and form system integration.
source: .agents/skills/shadcn-specialist/SKILL.md
---
